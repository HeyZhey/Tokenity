    ...
    private var header: some View {
        HStack(spacing: 15) {
            ...
            VStack(alignment: .leading, spacing: 3) {
                Text("Tokenity")
                    .font(.tokenityText(22, weight: .semibold))
        ...
        VStack(alignment: .leading, spacing: 24) {
            VStack(alignment: .leading, spacing: 8) {
                Text(page.eyebrow)
                    ...
                    .foregroundStyle(theme.accent)
                Text(page.title)
                    .font(.tokenityText(28, weight: .semibold))
                    .foregroundStyle(theme.text)
            }
    ...
    private var installPage: some View {
        VStack(alignment: .leading, spacing: 18) {
            ...
            OnboardingInstruction(
                ...
                detail: "Place compatible MLX model folders under /Users/Shared/TokenityModels on each participating Mac.",
...
private struct OnboardingCard: View {
    ...
    var body: some View {
        ...
        .background(theme.group, in: RoundedRectangle(cornerRadius: 11))
        .overlay(
