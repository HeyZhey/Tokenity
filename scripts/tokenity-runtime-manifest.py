...
EXPECTED_INSTALL_ROOT = Path("/Users/Shared/TokenityRuntime")
TOKENITY_CODE_PATH = "/Users/Shared/TokenityCode"
...
def normalize_entrypoint_shebangs(bin_directory: Path) -> None:
    expected = b"#!/Users/Shared/TokenityRuntime/current/.venv/bin/python\n"
...
def normalize_runtime(root: Path, lock: dict[str, Any]) -> None:
    ...
    if root == EXPECTED_INSTALL_ROOT:
        raise RuntimeValidationError(
            "refusing to normalize the live /Users/Shared runtime; import it into staging first"
        )
