...
| 页面 | 参考图 |
|---|---|
| Overview | `/path/to/Tokenity-Stable/docs/ui-style-reference-2026-07-29/01-overview.png` |
| Cluster | `/path/to/Tokenity-Stable/docs/ui-style-reference-2026-07-29/02-cluster.png` |
| Models | `/path/to/Tokenity-Stable/docs/ui-style-reference-2026-07-29/03-models.png` |
| Chat | `/path/to/Tokenity-Stable/docs/ui-style-reference-2026-07-29/04-chat.png` |
| Network / RDMA | `/path/to/Tokenity-Stable/docs/ui-style-reference-2026-07-29/05-network-rdma.png` |
| API Access | `/path/to/Tokenity-Stable/docs/ui-style-reference-2026-07-29/06-api-access.png` |
| Logs | `/path/to/Tokenity-Stable/docs/ui-style-reference-2026-07-29/07-logs.png` |
| Settings | `/path/to/Tokenity-Stable/docs/ui-style-reference-2026-07-29/08-settings.png` |

新 Logo 的唯一源文件：

```text
/path/to/Tokenity-Stable/Logo-New.png
```
...
1. /path/to/Tokenity-Stable/docs/live-hardware-validation-2026-07-26.md
2. /path/to/Tokenity-Stable/apps/TokenityControl/Sources/TokenityControl/Theme.swift
3. /path/to/Tokenity-Stable/apps/TokenityControl/Sources/TokenityControl/Components.swift
4. /path/to/Tokenity-Stable/apps/TokenityControl/Sources/TokenityControl/Views.swift
5. /path/to/Tokenity-Stable/apps/TokenityControl/Sources/TokenityControl/ChatViews.swift
6. /path/to/Tokenity-Stable/apps/TokenityControl/Sources/TokenityControl/MenuBar.swift
7. /path/to/Tokenity-Stable/apps/TokenityControl/Sources/TokenityControl/OnboardingView.swift
8. /path/to/Tokenity-Stable/apps/TokenityControl/Sources/TokenityControl/TokenityControlApp.swift
...
- /path/to/Tokenity-Stable/docs/ui-style-reference-2026-07-29/01-overview.png
- /path/to/Tokenity-Stable/docs/ui-style-reference-2026-07-29/02-cluster.png
...
/path/to/Tokenity-Stable/docs/ui-style-reference-2026-07-29/04-chat.png
...
- /path/to/Tokenity-Stable/docs/ui-style-reference-2026-07-29/03-models.png
- /path/to/Tokenity-Stable/docs/ui-style-reference-2026-07-29/05-network-rdma.png
...
- /path/to/Tokenity-Stable/docs/ui-style-reference-2026-07-29/06-api-access.png
- /path/to/Tokenity-Stable/docs/ui-style-reference-2026-07-29/07-logs.png
- /path/to/Tokenity-Stable/docs/ui-style-reference-2026-07-29/08-settings.png
