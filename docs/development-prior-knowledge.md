...
| 用途 | 路径 |
| --- | --- |
| 唯一源码仓库 | `/Users/zxc/Documents/Tokenity-Stable` |
| SwiftUI 工程 | `/Users/zxc/Documents/Tokenity-Stable/apps/TokenityControl` |
| UI 启动脚本 | `/Users/zxc/Documents/Tokenity-Stable/scripts/run-tokenity-control-app.sh` |
| UI 构建脚本 | `/Users/zxc/Documents/Tokenity-Stable/scripts/build-tokenity-control-app.sh` |
| 完整基线验证 | `/Users/zxc/Documents/Tokenity-Stable/scripts/verify-stable-baseline.sh` |
| 默认 Debug App | `/Users/zxc/Documents/Tokenity-Stable/apps/TokenityControl/.build/arm64-apple-macosx/debug/TokenityControl-Stable.app` |
...
| 模型根目录 | `/Users/Shared/TokenityModels` |
| 正式安装的共享代码 | `/Users/Shared/TokenityCode` |
...
- [ ] 当前目录是 `/Users/zxc/Documents/Tokenity-Stable`
