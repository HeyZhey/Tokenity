...
`/Users/zxc/Documents/Tokenity-Stable`. The oMLX and exo trees under
`/Users/zxc/Documents/MLX-Distributed` were read-only design references. The
...
`/Users/zxc/Documents/MLX-Distributed`. It was terminated immediately by exact
...
- Mac A: LAN `192.168.5.23`, active `rdma_en4`, RDMA IP `192.168.0.1`.
- Mac B: LAN `192.168.5.75`, active `rdma_en5`, RDMA IP `192.168.0.2`.
- Both: runtime Python `/Users/Shared/TokenityRuntime/current/.venv/bin/python`,
