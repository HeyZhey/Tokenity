...
固定的 `512×256`、124 帧、28-step MiniMax H3 请求通过 Agent 网关完成，并返回
完整 RGB8 帧与立体声 PCM 音频：
...
这些数据来自一套已经验证的双机配置，并不是所有硬件的通用成绩。实际性能会受到
Mac 型号、checkpoint、原生 Runtime、画面尺寸、步数和 Thunderbolt/RDMA 拓扑
影响。完整协议、基准工具、指纹和复现说明请参阅
